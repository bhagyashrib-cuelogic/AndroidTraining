...
class ListAdapter(val context: Context, val list: ArrayList<PresidentData>) : BaseAdapter() {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view: View = LayoutInflater.from(context).inflate(R.layout.list_layout, parent, false)
